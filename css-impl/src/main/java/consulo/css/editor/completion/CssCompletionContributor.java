...
public class CssCompletionContributor extends CompletionContributor {
    public CssCompletionContributor() {
        extend(
            ...
            PlatformPatterns.psiElement().withParent(PsiXStyleSheetProperty.class),
            (completionParameters, processingContext, completionResultSet) ->
            {
                ...
                for (XStyleSheetProperty property : xStyleSheetTable.getProperties()) {
                    ...
                    String defaultText = StringUtil.join(
                        property.getInitialEntries(),
                        entry -> {
        ...
        extend(
            CompletionType.BASIC,
            PlatformPatterns.psiElement().withParent(PsiXStyleSheetPropertyValuePart.class),
            (completionParameters, processingContext, completionResultSet) -> {
        ...
        extend(
            ...
            PlatformPatterns.psiElement().withParent(PsiXStyleSheetPropertyValuePart.class),
            (completionParameters, processingContext, completionResultSet) ->
                completionResultSet.addElement(LookupElementBuilder.create("!important")
                    .withLookupString("important")
                    .withPresentableText("!important")
                    .bold())
        );
    }
